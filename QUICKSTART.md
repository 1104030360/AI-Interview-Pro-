...
│
├── archive/                 # 歸檔區
│   └── legacy_v1/           # 舊版程式碼 (Auto_Switch.py, project.py)
│
└── docs/                    # 文件 📚
...
- **重構對比報告：**
  [docs/schedule/reports/2025-11-16-重構對比-REP.md](docs/schedule/reports/2025-11-16-%E9%87%8D%E6%A7%8B%E5%B0%8D%E6%AF%94-REP.md)
